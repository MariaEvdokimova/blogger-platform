...
export const appConfig = {
  ...
  MONGO_URL: process.env.MONGO_URL || 'mongodb://localhost:27017', //'mongodb+srv://admin:admin@blogger-platform-dev-cl.vojnv73.mongodb.net/?retryWrites=true&w=majority&appName=blogger-platform-dev-cluster',
